...
import android.example.weatherbypauli.FutureListWeatherFactory
...
class FutureListWeatherFragment : ScopedFragment(), KodeinAware {
    ...
    private val viewModelFactory: FutureListWeatherFactory by instance()
    ...
    private fun List<UnitSpecificSimpleFutureEntry>.toFutureWeatherItems() : List<FutureWeatherItem> {
        return this.map {
